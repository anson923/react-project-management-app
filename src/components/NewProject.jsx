...
export default function NewProject({onCancelButtonClicked, onAddProject}){
  ...
  return (
    <div className="w-[35rem] mt-16">
      <menu className="flex items-center justify-end gap-4 my-4">
        <li>
          <button onClick={onCancelButtonClicked} className="text-stone-800 hover:text-stone-950">Cancel</button>
        </li>
        <li>
